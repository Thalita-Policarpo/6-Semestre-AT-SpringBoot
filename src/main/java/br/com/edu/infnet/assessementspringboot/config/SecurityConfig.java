package br.com.edu.infnet.assessementspringboot.config;

import br.com.edu.infnet.assessementspringboot.service.CustomUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/public/**").permitAll() // permitindo que acessem a minha API sem autenticação
